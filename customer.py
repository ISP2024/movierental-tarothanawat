...
class Customer:
    ...
    def statement(self):
        ...
        frequent_renter_points, statement, total_amount = self.get_price(frequent_renter_points, rental_fmt, statement,
                                                                         total_amount)
    ...
    def get_price(self, frequent_renter_points, rental_fmt, statement, total_amount):
